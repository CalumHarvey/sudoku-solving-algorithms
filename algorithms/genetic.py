...
class Tournament(object):
    ...
    Two individuals are selected from the population pool a.nd a random number in [0, 1] is chosen. If this number is less than the 'selection rate' (e.g 0.85), then the fitter individual is selected; otherwise, the weaker one is selected.
    """
