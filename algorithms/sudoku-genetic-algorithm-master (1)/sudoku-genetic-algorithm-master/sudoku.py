...
class Candidate(object):
    ...
    def update_fitness(self):
        ...
        for i in range(0, Nd):  # For each column...
            # For each number within the current column...
            for j in range(0, Nd):
...
class CycleCrossover(object):
    ...
    def crossover_rows(self, row1, row2):
        ...
        remaining = [i for i in range(0, Nd+1)]
        cycle = 0
...
class Sudoku(object):
    ...
    def load(self):
        ...
        values = numpy.array([[0, 0, 0, 7, 0, 8, 0, 0, 3], [0, 0, 0, 0, 5, 0, 0, 0, 0], [0, 6, 3, 4, 9, 0, 0, 5, 7], [0, 3, 1, 0, 0, 2, 0, 0, 0], [9, 0, 8, 0, 0, 7, 0, 6, 5], [6, 5, 0, 0, 0, 4, 0, 1, 0], [0, 0, 9, 0, 0, 0, 0, 0, 0], [0, 0, 6, 1, 3, 0, 0, 0, 9], [5, 0, 0, 0, 7, 0, 8, 3, 0]])#numpy.loadtxt(f).reshape((Nd, Nd)).astype(int)
